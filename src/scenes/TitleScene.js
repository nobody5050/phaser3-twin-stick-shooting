...
//
		...
		if (valid) {
			...
			var dokmiBoxOutline = this.add.rectangle(window.innerWidth * 0.75, 300, window.innerWidth * 0.5, 200, "white")
			var dokmiBoxFill = this.add.rectangle(window.innerWidth * 0.75 - 5, 295, window.innerWidth * 0.5 - 10, 190, "#56ac68")
		} else {

...
//
		...
		if (valid) {
			...
			var dokmiBoxOutline = this.add.rectangle(window.innerWidth * 0.50, 300, window.innerWidth * 0.5, 200, "#FFFFFF")
			var dokmiBoxFill = this.add.rectangle(window.innerWidth * 0.50, 295, window.innerWidth * 0.5 - 10, 190, '#56ac68')
		} else {
